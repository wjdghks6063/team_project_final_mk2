...
public class CommonUtil_pyw {
	//첨부파일 기부게시판  주소 용우	
	public static String getFile_dir_dona() {
		return "C:/Users/jsl505/Desktop/park_work/spring_team_pjt_give/src/main/webapp/webContent/file_room/dona/";
				
	}	

//첨부파일 봉사게시판  주소 용우
	public static String getFile_dir_vol() {
		return "C:/Users/jsl505/Desktop/park_work/spring_team_pjt_give/src/main/webapp/webContent/file_room/vol/";
				
	}	
	//첨부파일 지역 뉴스 주소	용우
	public static String getFile_dir_local() {
		return "C:/Users/jsl505/Desktop/park_work/spring_team_pjt_give/src/main/webapp/webContent/file_room/local/";
		
	}	

	//첨부파일 공지사항 주소 용우	
	public static String getFile_dir_notice() {
	return "C:/Users/jsl505/Desktop/park_work/spring_team_pjt_give/src/main/webapp/webContent/file_room/notice/";
...
//	
	...
	public static String dayaccount(String date) {
		String today = CommonUtil_pyw.getToday2();
