...
public class Mypage_activity implements Command {
	...
	public void execute(HttpServletRequest request) {
		...
		if(day_1 == null) {
	      ...
	      int total_count = my_dao.getTotalcount(id,day_1,day_2); // 전체 행수
		...
		ArrayList<Mypage_dto> dtos = my_dao.getActivity1day(id, day_1, day_2, end+more_final);
