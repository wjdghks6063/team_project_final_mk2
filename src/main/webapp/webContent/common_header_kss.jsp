...
<link rel="stylesheet" type="text/css" href="css/css_kss/reset.css" />
<link rel="stylesheet" type="text/css" href="css/css_kss/base.css" />
<link rel="stylesheet" type="text/css" href="css/css_kss/sub.css" />
<script type="text/javascript" src="js/jquery-1.8.1.min.js"></script>
<script type="text/javascript" src="js/common.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet"> <!--CDN 링크 -->

<link href="css/css_kss/header.css" rel="stylesheet"> <!-- header css-->
<link href="css/css_kss/sub-header.css" rel="stylesheet"> <!--서브 header css-->

<!-- 임시 서브 헤더-->
<link href="css/css_kss/view.css" rel="stylesheet"> <!--서브 header css-->

<link href="css/css_kss/global.css" rel="stylesheet"> <!--배너 css-->
...
<link href="css/css_kss/summernote-lite.css" rel="stylesheet" >
