  ...
  <footer class="footer-box">
    <div class="footer-top">
        <dl class="footer-top-box">
            <dt class="footer-top-notice"><a href="Notice">공지사항</a></dt>
        ...
        <div class="service-info-box" aria-hidden="false">
            <dl class="service-info-first-line">
                <dt class="service-info-first-line-title"> Isee U 안내</dt>
                <dd class="service-info-first-line-item"><a href="Company">IseeU 소개</a></dd>
                <dd class="service-info-first-line-item"><a href="">IseeU 현황</a></dd>
                <dd class="service-info-first-line-item"><a href="">파트너 소개</a></dd>
                <dd class="service-info-first-line-item"><a href="Gil">오시는 길</a></dd>
            </dl>
            <dl class="service-info-first-line">
                <dt class="service-info-first-line-title">제휴∙단체안내</dt>
                <dd class="service-info-first-line-item"><a href="">IseeU 가입</a></dd>
    ...
    <div class="footer-info-box">
        <div class="footer-info-inner">
            <ul class="footer-info-list">
                <li class="footer-info-item"><a href="" target="콘텐츠 저작권정책">콘텐츠 저작권정책</a></li>
            ...
            <ul class="footer-info-list">
                ...
                <li class="footer-info-item">대표 : IseeU</li>
