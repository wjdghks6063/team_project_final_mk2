...
<div class="sub-write">
			...
			<form name="noti" enctype="multipart/form-data">
					<h2 class="title2"> 공지사항을 작성해주세요</h2>
					...
					<fieldset>
						...
						<table class="table">
							<caption><p style="font-size:30px; margin-bottom:20px;">중립적인 공지사항을 작성합시다.</p></caption>
							<colgroup>
								<col width="20%">
								<col width="20%">
								<col width="*">
	...
	height:300px;
							...
							<tr>
								...
								<td><input type="file" name="t_attatch" class="file" id="file" style="border:1px solid #333333"></label></td>
							</tr>
