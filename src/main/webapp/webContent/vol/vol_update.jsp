...
<div class="sub-write">
	...
	height:300px;
							...
							<tr>
								...
								<td colspan="2">
									<input type="radio"  name="t_local" value="yuseong" <c:if test="${t_dto.getLocal() eq 'yuseong'}">checked</c:if> class="tser" style="border:1px solid #333333">&nbsp 유성구
									<input type="radio"  name="t_local" value="dong-gu" <c:if test="${t_dto.getLocal() eq 'dong-gu'}">checked</c:if>  class="tser" style="border:1px solid #333333">&nbsp 동구
									<input type="radio"  name="t_local" value="seo-gu" <c:if test="${t_dto.getLocal() eq 'seo-gu'}">checked</c:if>  class="tser" style="border:1px solid #333333">&nbsp 서구
									<input type="radio"  name="t_local" value="daedeok" <c:if test="${t_dto.getLocal() eq 'daedeok'}">checked</c:if> class="tser" style="border:1px solid #333333">&nbsp 대덕구
									<input type="radio"  name="t_local" value="jung-gu" <c:if test="${t_dto.getLocal() eq 'jung-gu'}">checked</c:if> class="tser" style="border:1px solid #333333">&nbsp 중구
								</td>
