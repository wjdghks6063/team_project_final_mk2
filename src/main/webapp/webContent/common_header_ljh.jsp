...
<link rel="stylesheet" type="text/css" href="css/css_ljh/reset.css" />
<link rel="stylesheet" type="text/css" href="css/css_ljh/base.css" />
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
<script type="text/javascript" src="js/jquery-1.8.1.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet"> <!--CDN 링크 -->

<link href="css/css_ljh/header.css" rel="stylesheet"> <!-- header css-->
<link href="css/css_ljh/sub-header.css" rel="stylesheet"> <!--서브 header css-->

<!-- 임시 서브 헤더-->
<link href="css/css_ljh/view.css" rel="stylesheet"> <!--서브 header css-->
<link href="css/css_ljh/global.css" rel="stylesheet">
