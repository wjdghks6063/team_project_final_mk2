...
<link rel="stylesheet" type="text/css" href="css/css_pyw/reset.css" />
<link rel="stylesheet" type="text/css" href="css/css_pyw/base.css" />
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
<script src="/js/common.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet"> <!--CDN 링크 -->

<link href="css/css_pyw/header.css" rel="stylesheet"> <!-- header css-->
<link href="css/css_pyw/sub-header.css" rel="stylesheet"> <!--서브 header css-->

<!-- 임시 서브 헤더-->
<link href="css/css_pyw/view.css" rel="stylesheet"> <!--서브 header css-->
<link href="css/css_pyw/global.css" rel="stylesheet">
